      ...
      <div className="space-y-3">
        {(data?.appointments || []).map(a => (
          <div key={a._id} className="bg-white dark:bg-dark-card rounded-2xl border border-gray-100 dark:border-dark-border p-4 flex items-center gap-4">
            ...
            <div className="flex-1"><p className="font-medium text-gray-900 dark:text-white">{a.patientId?.name || 'Patient'}</p><p className="text-sm text-gray-500">{a.type || 'Consultation'} • {a.duration || 30}min</p></div>
